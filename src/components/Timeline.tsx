...
export default function TimelineSection() {
  const events = [
    { year: "20 April 2026 - 23 May 2026", title: "Open Registration: Offline Competition", desc: "J-song, Coswalk SMA-SMK, Coswalk Umum, Dance Cover, Project Sekai Tournament", color: "var(--blue)" },
    { year: "20 April 2026 - 24 May 2026", title: "Open Registration: Online Competition", desc: "Ilustrasi Digital, Poster SMA-SMK", color: "var(--blue)" },
    ...
    { year: "30 May 2026", title: "Day 1 Event", desc: "J-song, Coswalk Umum, Coswalk SMA-SMK", color: "var(--yellow)" },
